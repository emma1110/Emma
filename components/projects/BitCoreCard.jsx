...
export default function BitCoreCard() {
  return (
    <div className="relative w-full overflow-hidden rounded-[24px] bg-gradient-to-b from-[#ff5731] to-[#fea213] transition-all duration-500 ease-out hover:scale-[1.005] cursor-pointer flex flex-col lg:block min-h-[560px] lg:h-[576px]">
      {/* Logo · CASE STUDY */}
